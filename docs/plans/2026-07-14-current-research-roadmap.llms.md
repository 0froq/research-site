...
**Files:** - Modify: `shared/R/kinematics-helpers.R` - Modify: `explorations/warming-acceleration/draft/01-global-kinematics.qmd`
...
**Files:** - Create: `shared/R/seasonal-ice-helpers.R` - Modify: `explorations/warming-acceleration/prose/seasonal-ice-diagnostics.qmd`
...
**Files:** - Create: `data-process/steps/15-pca-stability/run.jl` - Create: `data-process/steps/15-pca-stability/README.md` - Create: `shared/R/pca-stability-helpers.R` - Modify: `explorations/warming-acceleration/draft/02-warming-patterns.qmd`
...
**Files:** - Create: `shared/R/era5-association-helpers.R` - Modify: `explorations/warming-acceleration/prose/era5-association-scope.qmd`
...
**Files:** - Modify: `docs/analysis-contract.qmd`, `AGENTS.md`, affected prose and draft files
