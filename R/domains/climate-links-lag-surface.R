...
prepare_pca_seasonal_lag_surface <- function() {
  surface <- read_csv(dataset_file("seasonal-lag-surface",
    "cell_seasonal_teleconnection_lag_surface.csv"), show_col_types = FALSE) |>
