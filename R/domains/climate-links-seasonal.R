...
prepare_pca_seasonal_teleconnection_data <- function(
    ...
    correlation_path = dataset_file("seasonal-teleconnection-screen", "lake_seasonal_teleconnection_correlations.csv"),
  ...
  pca_dir <- file.path(dataset_dir("spatial-pca"), grid)
