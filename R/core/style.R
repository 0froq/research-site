...
# `data` remains only for temporary compatibility wrappers during migration.
source(file.path(project_dir, "R", "core", "catalog.R"))
source(file.path(project_dir, "R", "core", "contracts.R"))
