...
Adding available residence time, discharge, watershed area, volume, shoreline development, terrain slope, and reservoir fraction does not remove the PC2–PC3 association. The separate [lake-context exclusion check](../../../explorations/warming-acceleration/prose/pca-seasonal-teleconnection-lake-context.llms.md) gives the same-cell model comparison and all grid, LOCO, and LODO tests.
