...
Detailed construction, LOCO alignment, and projection boundary are specified in [the PCA stability contract](../investigations/pca-stability-contract.qmd) and [Spatially balanced PCA](../../../reference/methods/index.qmd#spatially-balanced-pca).
...
Requirements are specified in [the association contract](../investigations/era5-association-scope.qmd). Chapter 3 remains inactive until inputs, temporal alignment, confounding structure, and held-out evaluation are implemented.
