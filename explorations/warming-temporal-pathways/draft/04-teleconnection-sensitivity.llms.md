...
Full validation, neighbour diagnostics, and trajectory composites are in [Selected Seasonal Teleconnection Candidates](../../../explorations/warming-temporal-pathways/investigations/pca-selected-seasonal-teleconnection.llms.md).
