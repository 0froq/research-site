...
Detailed loading interpretation, score-pole composites, and LOCO matching are retained in [PCA Stability Contract](../../../explorations/warming-temporal-pathways/investigations/pca-stability-contract.llms.md). PCA identifies reproducible covariance structure; it does not identify a forcing mechanism by itself.

> loading 解读、score-pole 复合和 LOCO 匹配详见 PCA Stability Contract。PCA 识别可重复协变结构，本身不识别驱动机制。

Construction, loading interpretation, maps, poles, and LOCO diagnostics remain in [PCA Stability Contract](../../../explorations/warming-temporal-pathways/investigations/pca-stability-contract.llms.md) and the earlier detailed [PCA exploration](../../../explorations/warming-temporal-pathways/draft/02-warming-patterns.llms.md).
