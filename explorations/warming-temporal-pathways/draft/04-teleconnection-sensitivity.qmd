...
ggplot(tele_spatial$primary) +
  ...
  theme_map_grid(base_size = 8) +
  theme(legend.position = "bottom", legend.key.width = unit(24, "mm"))
```
...
Full validation, neighbour diagnostics, and trajectory composites are in [Selected Seasonal Teleconnection Candidates](../investigations/pca-selected-seasonal-teleconnection.qmd).
