# Evidence map and writing protocol

This page is the audit boundary for the formal manuscript. It records where a manuscript statement gets its support; it does not duplicate figures, numerical results, or literature extracts.
...
- [Introduction](../../../explorations/warming-temporal-pathways/manuscript/01-introduction.llms.md): every external factual or novelty claim must have a citation and a corresponding reviewed paper note. Comparator scope is maintained in [Novelty and comparators](../../../explorations/warming-temporal-pathways/literature/novelty-and-comparators.llms.md).
