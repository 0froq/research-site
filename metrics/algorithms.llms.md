...
Sequential T-test Analysis of Regime Shifts (Rodionov 2004). Detects abrupt shifts in the mean of a time series.
...
- Regime length is not necessarily \\l\\; a new regime can start at any point after the shift
